...
type PaymentOrder struct {
	...
	// RawProviderPayload holds the value of the "raw_provider_payload" field.
...
func (*PaymentOrder) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case paymentorder.FieldAmount, paymentorder.FieldCreditedAmount:
			values[i] = new(sql.NullFloat64)
		case paymentorder.FieldID, paymentorder.FieldUserID:
			values[i] = new(sql.NullInt64)
		case paymentorder.FieldProvider, paymentorder.FieldOutTradeNo, paymentorder.FieldProviderTradeNo, paymentorder.FieldTitle, paymentorder.FieldStatus, paymentorder.FieldRawProviderPayload:
...
func (_m *PaymentOrder) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case paymentorder.FieldRawProviderPayload:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field raw_provider_payload", values[i])
			} else if value.Valid {
				_m.RawProviderPayload = new(string)
				*_m.RawProviderPayload = value.String
			}
...
func (_m *PaymentOrder) String() string {
	...
	builder.WriteString(", ")
	if v := _m.RawProviderPayload; v != nil {
		builder.WriteString("raw_provider_payload=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
