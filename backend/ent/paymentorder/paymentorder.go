...
const (
	...
	FieldStatus = "status"
	// FieldRawProviderPayload holds the string denoting the raw_provider_payload field in the database.
	FieldRawProviderPayload = "raw_provider_payload"
...
// ByRawProviderPayload orders the results by the raw_provider_payload field.
func ByRawProviderPayload(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRawProviderPayload, opts...).ToFunc()
}
