...
import (
	...
	"github.com/B022MC/b022hub/internal/testutil"
...
func TestSoraGatewayHandler_ChatCompletions(t *testing.T) {
	...
	handler := NewSoraGatewayHandler(gatewayService, soraGatewayService, nil, concurrencyService, billingCacheService, nil, cfg)
