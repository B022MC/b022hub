...
func TestApiKeyAuthWithSubscriptionGoogle_RejectsInactiveBoundGroup(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.Equal(t, "Group assigned to API key is not active", resp.Error.Message)
