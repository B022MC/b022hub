...
const DefaultCSPPolicy = "default-src 'self'; script-src 'self' __CSP_NONCE__ https://challenges.cloudflare.com https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https: http://127.0.0.1:* http://localhost:* http://[::1]:* https://127.0.0.1:* https://localhost:* https://[::1]:*; frame-src https://challenges.cloudflare.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'"
...
type RateLimitConfig struct {
	...
	AutoDeleteRateLimitedAccounts bool `mapstructure:"auto_delete_rate_limited_accounts"` // 是否自动删除账号级受限账号
}
...
func setDefaults() {
	...
	viper.SetDefault("rate_limit.auto_delete_rate_limited_accounts", false)
