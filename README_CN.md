...
**基于原始 Sub2API 的个性化 AI API 网关二开项目**

[English](README.md) | 中文

</div>

> **b022hub 基于原始 Sub2API 项目做了品牌、首页视觉和自部署体验方面的个性化改造。当前仓库面向自部署与个人定制场景。**
...
<td valign="middle"><b><a href="https://shop.pincc.ai/">PinCC</a></b> 属于 b022hub 所基于的上游 Sub2API 生态。如果你需要参考上游托管服务或集成能力，可以从这里继续查看。</td>
</tr>
</table>

## 生态项目

与 b022hub 所依赖的上游生态相关的社区项目：
...
通过 Nginx 反向代理 b022hub（或 CRS 服务）并搭配 Codex CLI 使用时，需要在 Nginx 配置的 `http` 块中添加：
...
b022hub 支持 [Antigravity](https://antigravity.so/) 账户，授权后可通过专用端点访问 Claude 和 Gemini 模型。
