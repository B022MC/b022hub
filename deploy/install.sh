#!/bin/bash
#
# b022hub Installation Script
# b022hub 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/B022MC/b022hub/main/deploy/install.sh | bash
#
...
declare -A MSG_ZH=(
    ...
    # Completion
    ["install_complete"]="b022hub 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 b022hub 服务："
    ...
    ["not_installed"]="b022hub 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 b022hub。"
    ...
    ["uninstall_complete"]="b022hub 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 b022hub"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 b022hub"
    ...
    ["server_config_desc"]="配置 b022hub 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="b022hub Installation Script"
    ...
    # Completion
    ["install_complete"]="b022hub installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start b022hub service:"
    ...
    ["not_installed"]="b022hub is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove b022hub from your system."
    ...
    ["uninstall_complete"]="b022hub has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install b022hub"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove b022hub"
    ...
    ["server_config_desc"]="Configure b022hub server listen address"
...
[Unit]
Description=b022hub - AI API Gateway Platform
Documentation=https://github.com/B022MC/b022hub
...
# Requires: b022hub must already be installed
install_version() {
