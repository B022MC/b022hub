...
<template>
  <div :class="['ops-card-shell flex flex-col gap-4 rounded-3xl', props.fullscreen ? 'p-8' : 'p-6']">
    <!-- Top Toolbar -->
    <div class="ops-divider-border flex flex-wrap items-center justify-between gap-4 border-b pb-4">
      <div>
      ...
      <div class="flex flex-wrap items-center gap-3">
        <template v-if="!props.fullscreen">
          ...
          <div class="ops-divider-bg mx-1 hidden h-4 w-[1px] sm:block"></div>
        ...
        <button
          ...
          type="button"
          class="ops-button flex h-8 w-8 items-center justify-center rounded-lg transition-colors"
          :disabled="loading"
        ...
        <div v-if="!props.fullscreen" class="ops-divider-bg mx-1 hidden h-4 w-[1px] sm:block"></div>

        <!-- Alert Rules Button (hidden in fullscreen) -->
        <button
          v-if="!props.fullscreen"
          type="button"
          class="ops-button-accent flex h-8 items-center gap-1.5 rounded-lg px-3 text-xs font-bold transition-colors"
        ...
        <button
          v-if="!props.fullscreen"
          type="button"
          class="ops-button flex h-8 items-center gap-1.5 rounded-lg px-3 text-xs font-bold transition-colors"
    ...
    <div v-if="overview" class="grid grid-cols-1 gap-6 lg:grid-cols-12">
      ...
      <div :class="['ops-card-muted rounded-2xl lg:col-span-5', props.fullscreen ? 'p-6' : 'p-4']">
        <div class="grid h-full grid-cols-1 gap-6 md:grid-cols-[200px_1fr] md:items-center">
          <!-- 1) Health Score -->
          <div
            class="ops-divider-border group relative flex cursor-pointer flex-col items-center justify-center rounded-xl py-2 transition-all hover:bg-white/60 dark:hover:bg-dark-800/60 md:border-r md:pr-6"
          >
            ...
            >
              <div class="ops-popover rounded-xl p-4">
                <h4 class="ops-divider-border mb-3 flex items-center gap-2 border-b pb-2 text-sm font-bold text-gray-900 dark:text-white">
                ...
                <div class="space-y-3">
                  <div v-for="(item, idx) in diagnosisReport" :key="idx" class="flex gap-3">
                    ...
                    <div class="flex-1">
                      ...
                      <div v-if="item.action" class="ops-link mt-1 flex items-center gap-1 text-[11px]">
                ...
                <div class="ops-divider-border mt-3 border-t pt-2 text-[10px] text-gray-400">
      ...
      <div class="grid h-full grid-cols-1 content-center gap-4 sm:grid-cols-2 lg:col-span-7 lg:grid-cols-3">
        <!-- Card 1: Requests -->
        <div class="ops-card-muted rounded-2xl p-4" style="order: 1;">
          <div class="flex items-center justify-between">
            ...
            <button
              v-if="!props.fullscreen"
              class="ops-link text-[10px] font-bold hover:underline"
              type="button"
        ...
        <!-- Card 2: SLA -->
        <div class="ops-card-muted rounded-2xl p-4" style="order: 2;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
          ...
          <div class="ops-progress-track mt-3 h-2 w-full overflow-hidden rounded-full">
        ...
        <div class="ops-card-muted rounded-2xl p-4" style="order: 4;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
        ...
        <!-- Card 5: TTFT -->
        <div class="ops-card-muted rounded-2xl p-4" style="order: 5;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
        ...
        <div class="ops-card-muted rounded-2xl p-4" style="order: 3;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
            ...
            <button v-if="!props.fullscreen" class="ops-link text-[10px] font-bold hover:underline" type="button" @click="openErrorDetails('request')">
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>
        ...
        <div class="ops-card-muted rounded-2xl p-4" style="order: 6;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
            ...
            <button v-if="!props.fullscreen" class="ops-link text-[10px] font-bold hover:underline" type="button" @click="openErrorDetails('upstream')">
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>
    ...
    <div v-if="overview" class="ops-divider-border mt-2 border-t pt-4">
      <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <!-- CPU -->
        <div class="ops-card-subtle rounded-xl p-3">
          <div class="flex items-center gap-1">
        ...
        <div class="ops-card-subtle rounded-xl p-3">
          <div class="flex items-center justify-between gap-2">
            ...
            <button v-if="!props.fullscreen" class="ops-link text-[10px] font-bold hover:underline" type="button" @click="openJobsDetails">
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>
    ...
    <BaseDialog :show="showJobsDetails" :title="t('admin.ops.jobs')" width="wide" @close="showJobsDetails = false">
      ...
      <div v-else class="space-y-3">
        <div
          ...
          :key="hb.job_name"
          class="ops-card-subtle rounded-xl p-4"
        >
