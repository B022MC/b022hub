...
<template>
      ...
      <div class="ops-card-muted rounded-2xl p-4">
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          <details class="col-span-1 md:col-span-2">
            <summary class="ops-link cursor-pointer text-xs font-medium">
              {{ t('admin.ops.runtime.showAdvancedDeveloperSettings') }}
            </summary>
            <div class="ops-card-subtle mt-2 grid grid-cols-1 gap-3 rounded-lg p-3 md:grid-cols-2">
  ...
  <BaseDialog :show="showAlertEditor" :title="t('admin.ops.runtime.alertTitle')" width="extra-wide" @close="showAlertEditor = false">
    <div v-if="draftAlert" class="space-y-4">
      ...
      <div class="ops-card-muted rounded-2xl p-4">
        ...
        <div v-if="draftAlert.silencing.enabled" class="mt-4 space-y-4">
          ...
          <div class="ops-card-subtle rounded-xl p-4">
            ...
            <div v-if="!draftAlert.silencing.entries?.length" class="ops-card-muted mt-3 rounded-lg p-3 text-xs text-gray-500 dark:text-gray-400">
            ...
            <div v-else class="mt-4 space-y-4">
              <div
                ...
                :key="idx"
                class="ops-card-muted rounded-lg p-4"
              >
                <div class="mb-3 flex items-center justify-between">
      ...
      <details class="ops-card-muted rounded-lg p-3">
