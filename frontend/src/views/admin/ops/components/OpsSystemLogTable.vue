...
<template>
  <section class="ops-card-shell rounded-2xl p-4">
    <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
      ...
      <div class="flex flex-wrap items-center gap-2 text-xs">
        <span class="ops-pill-muted rounded-md px-2 py-1">队列 {{ health.queue_depth }}/{{ health.queue_capacity }}</span>
        <span class="ops-pill-muted rounded-md px-2 py-1">写入 {{ health.written_count }}</span>
    ...
    <div class="ops-card-muted mb-4 rounded-xl p-3">
    ...
    <div class="ops-table-shell overflow-hidden rounded-xl">
      ...
      <div v-else class="overflow-auto">
        <table class="min-w-full table-fixed divide-y divide-gray-200 dark:divide-dark-700">
          ...
          <tbody class="ops-table-body divide-y divide-gray-100 dark:divide-dark-800">
            <tr v-for="row in logs" :key="row.id" class="ops-table-row align-top">
