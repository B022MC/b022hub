...
<template>
  <BaseDialog :show="show" :title="modalTitle" width="full" @close="close">
    <div class="flex h-full min-h-0 flex-col">
      <!-- Filters -->
      <div class="ops-divider-border mb-4 flex-shrink-0 border-b pb-4">
        <div class="grid grid-cols-8 gap-2">
          <div class="col-span-2 compact-select">
            <div class="relative group">
              ...
              <input
                v-model="q"
                type="text"
                class="input w-full rounded-lg py-1.5 pl-9 pr-3 text-xs font-medium"
          ...
          <div class="flex items-center justify-end">
            <button type="button" class="ops-button rounded-lg px-3 py-1.5 text-xs font-semibold transition-colors" @click="resetFilters">
              {{ t('common.reset') }}
            </button>
          </div>
        </div>
