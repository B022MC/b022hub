...
function severityBadgeClass(severity: string | undefined): string {
  ...
  if (s === 'p2' || s === 'info') return 'bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300'
  if (s === 'p3') return 'bg-stone-100 text-stone-700 dark:bg-stone-900/30 dark:text-stone-300'
...
<template>
  <div class="ops-card-shell rounded-3xl p-6">
    ...
    <div v-else-if="empty" class="ops-divider-border rounded-xl border border-dashed p-8 text-center text-sm text-gray-500 dark:text-gray-400">
      {{ t('admin.ops.alertEvents.empty') }}
    </div>

    <div v-else class="ops-table-shell overflow-hidden rounded-xl">
      <div class="max-h-[600px] overflow-y-auto" @scroll="onScroll">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
          ...
          <tbody class="ops-table-body divide-y divide-gray-200 dark:divide-dark-700">
            <tr
              v-for="row in events"
              :key="row.id"
              class="ops-table-row cursor-pointer"
    ...
    >
      ...
      <div v-else class="space-y-5">
        <div class="ops-card-muted rounded-xl p-4">
          <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
              <div class="ops-card-subtle flex items-center gap-2 rounded-lg px-2 py-1">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="ops-card-muted rounded-xl p-4">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-2">
                ...
                <a
                  class="ops-button inline-flex items-center gap-1 rounded-md px-2 py-1 text-[11px] font-bold"
        ...
        <div class="ops-card-subtle rounded-xl p-4">
          ...
          <div v-else class="ops-table-shell overflow-hidden rounded-lg">
            <table class="min-w-full divide-y divide-gray-100 dark:divide-dark-700">
              ...
              <tbody class="divide-y divide-gray-100 dark:divide-dark-700">
                <tr v-for="it in history" :key="it.id" class="ops-table-row">
