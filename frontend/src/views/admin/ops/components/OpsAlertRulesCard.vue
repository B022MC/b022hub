...
<template>
  <div class="ops-card-shell rounded-3xl p-6">
    ...
    <div v-else-if="sortedRules.length === 0" class="ops-divider-border rounded-xl border border-dashed p-8 text-center text-sm text-gray-500 dark:text-gray-400">
      {{ t('admin.ops.alertRules.empty') }}
    </div>

    <div v-else class="ops-table-shell max-h-[520px] overflow-hidden rounded-xl">
      <div class="max-h-[520px] overflow-y-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
          ...
          <tbody class="ops-table-body divide-y divide-gray-200 dark:divide-dark-700">
            <tr v-for="row in sortedRules" :key="row.id" class="ops-table-row">
              <td class="px-4 py-3">
    ...
    >
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="ops-card-muted flex items-center justify-between rounded-xl px-4 py-3 md:col-span-2">
