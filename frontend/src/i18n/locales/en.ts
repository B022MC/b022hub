export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts and proxies. If you choose groups, every imported account will be bound to them automatically. Ensure existing data does not conflict.',
      dataImportGroupHint: 'The selected groups apply to every imported account in this batch. Leave empty to keep the current behavior and skip auto-binding.',
      dataImportFile: 'Data file',
      dataImportFileHint: 'JSON (.json), multiple files supported',
      ...
      dataImportResultSummary: 'Files succeeded {file_successful}/{file_total}, failed {file_failed}; Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Accounts created {account_created}, failed {account_failed}',
      dataImportErrors: 'Error Details',
      dataImportSuccess: 'Import completed: files succeeded {file_successful}/{file_total}, accounts {account_created}, failed {account_failed}',
      dataImportCompletedWithErrors: 'Import completed with errors: file failed {file_failed}, account failed {account_failed}, proxy failed {proxy_failed}',
    ...
    proxies: {
      ...
      dataImportHint: 'Import proxies from an exported JSON file or directly from a Clash subscription URL.',
      dataImportWarning: 'Import creates or reuses proxies, preserves status, and triggers latency checks after completion. Unsupported subscription node types are skipped.',
      dataImportSource: 'Import Source',
      dataImportModeFile: 'JSON File',
      dataImportModeSubscription: 'Subscription URL',
      dataImportFile: 'Data File',
      dataImportSubscriptionUrl: 'Subscription URL',
      dataImportSubscriptionPlaceholder: 'https://example.com/clash.yaml',
      dataImportSubscriptionHint: 'Only http/https/socks5/socks5h nodes can be imported right now. ss, vmess, trojan, and similar types will be skipped.',
      dataImportButton: 'Start Import',
      dataImporting: 'Importing...',
      dataImportSelectFile: 'Please select a data file',
      dataImportSelectSubscriptionUrl: 'Please enter a subscription URL',
